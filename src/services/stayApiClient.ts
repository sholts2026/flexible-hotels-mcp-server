...
export class StayApiClient {
  ...
  async searchHotels(params: {
      ...
      // practice (observed live, e.g. for a date/destination with zero availability)
      // it can come back as a non-array value (null, an object, or a message string)
      // instead of `[]`. Treat anything that isn't actually an array as "no results"
      // rather than crashing the whole date scan on a single malformed response.
